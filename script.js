(function( $ ) {
  ...
  $.fn.makeSwatches = function() {
    var swatchHolder = $('<ol/>', {'class': 'swatchHolder'}).prependTo(".swatch-container")
    ...
    $.each(colors, function() {
      ...
      if(this=="#FFFFFF"){
        $(swatch).css('border', '1px solid #aaa');
      } else{
        $(swatch).css('border', '1px solid transparent');
      }
